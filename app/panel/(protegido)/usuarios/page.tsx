...
import { listarUsuarios, listarMedicosParaVincular } from "@/lib/usuarios/gestionar";
...
export default async function PaginaUsuarios() {
  ...
  const [usuarios, medicos] = await Promise.all([listarUsuarios(), listarMedicosParaVincular()]);
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <VistaUsuarios usuarios={usuarios} medicos={medicos} idUsuarioActual={usuarioActual?.id ?? ""} />
    </div>
  );
}
